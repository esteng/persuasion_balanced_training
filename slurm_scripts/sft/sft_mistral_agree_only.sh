...
#SBATCH --job-name=sft
#SBATCH --output /data/elias_stengel_eskin/trained_calibration/logs/sft_agree.out


mistral_ckpt="mistralai/Mistral-7B-Instruct-v0.2" 
python trained_calibration/rl/train/train_dialogue.py \
	--output_dir dialogue_models/trivia_qa/mistral_v0.2_7B_sft_agree_filtered_big \
