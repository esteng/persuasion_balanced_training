...
#SBATCH --job-name=sft
#SBATCH --output /data/elias_stengel_eskin/trained_calibration/logs/sft_ltd_70b.out


llama_ckpt="meta-llama/Meta-Llama-3.1-70B-Instruct" 
python trained_calibration/rl/train/train_dialogue.py \
	--output_dir dialogue_models/trivia_qa/llama_3.1_70B_sft_limited_filtered_big \
