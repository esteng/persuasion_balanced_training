...
llama_sft_ckpt="dialogue_models/trivia_qa/llama_3.1_8B_sft_limited_filtered_big/checkpoint-240/" 
python trained_calibration/rl/train/train_dialogue.py \
	--output_dir dialogue_models/trivia_qa/llama_3.1_8B_combo_dpo_limited_filtered_big_${SEED}_seed \
