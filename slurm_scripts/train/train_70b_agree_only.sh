...
llama_sft_ckpt="dialogue_models/trivia_qa/llama_3.1_70B_sft_agree_filtered_big/checkpoint-240"
python trained_calibration/rl/train/train_dialogue.py \
	--output_dir dialogue_models/trivia_qa/llama_3.1_70B_dpo_agree_filtered_big_${SEED}_seed \
